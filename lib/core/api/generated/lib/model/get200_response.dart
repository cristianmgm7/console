...
class Get200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is Get200Response && other.message == message;
  ...
  @override
  String toString() => 'Get200Response[message=$message]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Get200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Get200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Get200Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Get200Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Get200Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
