...
class _AppButtonState extends State<AppButton>
  ...
  TextStyle get _textStyle {
    return switch (widget.size) {
      AppButtonSize.small => AppTextStyle.labelMedium,
      AppButtonSize.medium => AppTextStyle.labelLarge,
      AppButtonSize.large => AppTextStyle.titleSmall,
    };
  }
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: isDisabled
                  ...
                  : [
                      AppShadows.diffused,
                      if (_isHovered) AppShadows.colored(backgroundColor),
                    ],
            ),
