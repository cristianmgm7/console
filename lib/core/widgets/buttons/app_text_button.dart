...
class _AppTextButtonState extends State<AppTextButton>
  ...
  EdgeInsets get _padding {
    return switch (widget.size) {
      AppTextButtonSize.small => const EdgeInsets.symmetric(
          horizontal: 12,
          vertical: 6,
        ),
      AppTextButtonSize.medium => const EdgeInsets.symmetric(
          horizontal: 16,
          vertical: 8,
        ),
      AppTextButtonSize.large => const EdgeInsets.symmetric(
          horizontal: 20,
          vertical: 10,
        ),
    };
  ...
  TextStyle get _textStyle {
    return switch (widget.size) {
      AppTextButtonSize.small => AppTextStyle.labelMedium,
      AppTextButtonSize.medium => AppTextStyle.labelLarge,
      AppTextButtonSize.large => AppTextStyle.titleSmall,
    };
  }
