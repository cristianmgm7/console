...
class ConversationHeaderSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: 600, // Constrain the row width to make it more compact
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Left column: Cover art and statistics
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
          ...
          // Right column: Title/description and participants
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                if (conversation.hasParticipants) ParticipantsSection(conversation: conversation) else const SizedBox.shrink(),
              ],
            ),
          ),
        ],
